"""每个说话人的 silhouette score。--core 过滤到 48 人核心子集。"""
...
def main():
    ...
    parser.add_argument("--core", action="store_true", help="Filter to 48-person core subset")
    ...
    if args.core:
        ...
        for i, spk in enumerate(CORE_SPEAKERS):
